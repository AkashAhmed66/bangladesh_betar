...
<form method="POST" action="{{ $channel ? route('admin.podcast-channels.update', $channel) : route('admin.podcast-channels.store') }}" enctype="multipart/form-data" class="max-w-3xl">
    @csrf
